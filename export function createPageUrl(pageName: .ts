  ...
  useEffect(() => {
    if (component && typeof component === 'object') {
      ...
      for (const prop of invalidProps) {
        if (component && typeof component === 'object' && Object.hasOwn(component, prop)) {
...
export function validateReactComponentAdvanced(component: any): any {
  ...
  if (typeof component === 'object' && component !== null) {
    ...
    if (Object.hasOwn(component, '__proto__') || 
        Object.hasOwn(component, 'constructor') || 
        Object.hasOwn(component, 'prototype')) {
 ...
 */
export function sanitizeForReact(obj: any, seen = new WeakSet()): any {
  if (obj === null || obj === undefined) {
    return null;
  }
  ...
  if (Array.isArray(obj)) {
    return obj.map(item => sanitizeForReact(item, seen)).filter(item => item !== null);
  }
  ...
  if (typeof obj === 'object') {
    ...
    for (const [key, value] of Object.entries(obj)) {
      ...
      const sanitizedValue = sanitizeForReact(value, seen);
      if (sanitizedValue !== null) {
        sanitized[key] = sanitizedValue;
      }
    }
...
export function comprehensiveReactValidation(component: any): any {
  ...
  if (Array.isArray(component)) {
    return component.map(comprehensiveReactValidation);
  }
  ...
  // Import React if not already imported at the top of the file
  // Ensure React is imported for Fragment check
  // (If not already at the top of the file, add: import * as React from 'react';)
  if (
    (typeof component === 'object' &&
      component !== null &&
      component.$$typeof &&
      component.$$typeof.toString() === 'Symbol(react.fragment)')
  ) {
    return component;
  }
