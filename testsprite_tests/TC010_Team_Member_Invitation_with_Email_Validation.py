...
async def run_test():
    ...
    try:
        ...
        # Click on 'Manage Team' button to open team management page and invite user dialog.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[3]/main/div/div[4]/div[2]/div/div[2]/a[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the 'Invite Member' button to open the invite user dialog.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[3]/main/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in the Email Address field with a valid email and submit the invitation.
        frame = context.pages[-1]
        ...
        # Click 'Send Email Invitation' button to submit the invitation and verify the user appears as pending invite in the team members list.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[3]/form/div[6]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Invite Member' button to reopen invite user dialog and enter a valid email again.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[3]/main/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Check why 'Send Email Invitation' button is disabled and fix the form if needed, or try to enable the button by interacting with the form.
        frame = context.pages[-1]
