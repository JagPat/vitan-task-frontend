...
async def run_test():
    ...
    try:
        ...
        # Click the Login button to open the login UI for phone number input.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div[2]/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input a valid phone number in the WhatsApp number field and click the Login button to trigger WhatsApp verification code dispatch.
        frame = context.pages[-1]
        ...
        # Click the Verify Account button to trigger WhatsApp verification code dispatch and wait for the verification code input UI to appear.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[3]/div[2]/div[2]/form/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the Verify button to complete login and verify successful session creation.
        frame = context.pages[-1]
