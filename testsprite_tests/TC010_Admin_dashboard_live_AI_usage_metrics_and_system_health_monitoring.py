...
async def run_test():
    ...
    try:
        ...
        # Click the Login button to proceed with admin login.
        ...
        # Click the Login button to complete login after verification.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[3]/div[2]/div[2]/form/div[3]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on the 'AI Admin' link in the sidebar to access the AI Admin dashboard.
        frame = context.pages[-1]
