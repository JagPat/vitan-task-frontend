...
async def run_test():
    ...
    try:
        ...
        # Click on 'Create Task' button to start creating a new task.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[3]/main/div/div[4]/div[2]/div/div[2]/a/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in the task title, select 'External Person (WhatsApp Only)' for assignment, choose a team member, and submit the form to create the task.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[3]/main/div/div/form/div[2]/div[2]/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('Test WhatsApp Task')
        ...
        # Click the 'Create Task' button to submit the new task creation form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[3]/main/div/div/form/div[7]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the 'Create Task' button to submit the form and create the task assigned via WhatsApp.
        frame = context.pages[-1]
