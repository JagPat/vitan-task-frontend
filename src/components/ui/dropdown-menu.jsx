...
const DropdownMenuPortal = (props) => <DropdownMenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />;
...
const DropdownMenuSub = (props) => <DropdownMenuPrimitive.Sub data-slot="dropdown-menu-sub" {...props} />;
const DropdownMenuSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    data-inset={inset}
    className={cn(
      "focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden data-[inset]:pl-8 [&_svg]:size-4",
      className,
    )}
    {...props}
  >
